...
export function buildSucklessSystemPrompt(options: BuildSucklessSystemPromptOptions = {}): string {
	...
	let prompt = `You are an expert coding assistant operating inside pi, a coding agent harness. You follow the Suckless philosophy: minimalism, simplicity, and clarity. You help users by reading files, executing commands, editing code, and writing new files.
